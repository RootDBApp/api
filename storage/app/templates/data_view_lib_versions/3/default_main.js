...
// ***********************************************************
//
// You have to setup the type of graph and import the mandatory modules yourself.
// Edit initialization JS code opening menu "Data view" -> "Edit the initialization JS code..."

const labels = [];
// Ex: const labels = jsonResults.map(row => row.x_label);
